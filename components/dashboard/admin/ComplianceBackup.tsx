...
interface ComplianceBackupProps {
...
export default function ComplianceBackup({
  records,
  searchTerm,
  onSearchChange,
  onOpenEdit,
  onDelete,
}: ComplianceBackupProps) {
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5 font-medium">
            DPDP Act 2023 Encrypted Snapshots • Showing {filtered.length} Verified Snapshot(s)
          </p>
        </div>
