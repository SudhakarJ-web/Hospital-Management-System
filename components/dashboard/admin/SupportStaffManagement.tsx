  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-4 sm:p-6 space-y-4 sm:space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5 font-medium">
            Reception & Triage Staff Roster • Showing {filtered.length} Personnel
          </p>
        </div>
        <div className="relative w-full md:w-72">
          ...
          <input
            type="text"
            placeholder="Search support personnel..."
            value={searchTerm}
      ...
      <MetricsStrip
        ...
        totalLabel="Total Support Staff"
        activeLabel="On Duty"
        pendingLabel="Off Duty / Review"
      />
