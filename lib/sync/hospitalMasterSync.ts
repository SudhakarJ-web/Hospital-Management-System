...
export const INITIAL_HOSPITAL_DATA: Record<string, UnifiedRecord[]> = {
  ...
  VISITOR_PASS: [
    {
      id: "vis-1",
      reference_id: "VP-2026-001",
      category: "VISITOR_PASS",
      col1: "Rahul Patil",
      col2: "Patient: Amit Patil (Bed 204)",
      col3: "Orthopedics Ward",
      col4: "04:00 PM - 07:00 PM",
      col5: "Attendant Badge #01 Issued",
      status: "Active",
      created_at: "Today 04:00 PM",
    },
  ],
  Utility: [
    {
      ...
      category: "Utility",
      col1: "Hydraulic Wheelchair Unit 1",
      col2: "Front Desk Reception",
      col3: "Main Entrance Gate",
      col4: "Attendant: Suresh",
      col5: "Inspected & Cleared",
      status: "Active",
      created_at: "28/08/2026",
    },
    {
      id: "ut-2",
      reference_id: "UTIL-02",
      category: "Utility",
      col1: "Emergency Trauma Stretcher 4",
      col2: "Ambulance Bay",
      col3: "Ground Floor Triage",
      col4: "Attendant: Rajesh",
      col5: "Hydraulics Verified",
      status: "Active",
      created_at: "28/08/2026",
    },
  ],
